...
import com.matheusc.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Matheus Castro", "matheuscastro@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Matheus Bastos", "matheus.castro@gmail.com", "44689360022", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("99953323", "82348393"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Condomínio Jardim", "4", "Conjunto J, Casa 6", "Lago Norte", "71430456", cli2, c3);
		...
		ped1.getProdutos().addAll(Arrays.asList(ip1, ip2));
		ped2.getProdutos().addAll(Arrays.asList(ip3));
		
		p1.getPedidos().addAll(Arrays.asList(ip1));
		p2.getPedidos().addAll(Arrays.asList(ip3));
		p3.getPedidos().addAll(Arrays.asList(ip2));
